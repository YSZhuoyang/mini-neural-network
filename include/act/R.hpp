...
//   /// Ctor.
//   CUTLASS_DEVICE ReluEpilogueFunctor() { }

//   /// Ctor.
//   CUTLASS_DEVICE ReluEpilogueFunctor(Params const& _params) : params(_params) {}
...
//     cutlass::SharedStoreIteratorD::Fragment<ScalarAccum, size> FragAccum;
//     cutlass::SharedStoreIteratorD::Fragment<ScalarOutput, size> FragOutput;
// #pragma unroll
...
public:
    ...
    __device__ ReluEpilogueFunctor(Params const &params) : alpha_(params.alpha),
                                                   beta_(params.beta)
    {
    }
...
//     ReluEpilogueFunctor_epilogue_functor<float>>>
//     ReluGemm;

cudaError_t CutlassReluSgemmNN(
    int M,
    int N,
    int K,
    float alpha,
